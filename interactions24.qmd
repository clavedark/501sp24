...
The models we've considered so far have generally assumed \alert{structural stability} - that the intercepts and slopes are shared by all groups in the data. 
